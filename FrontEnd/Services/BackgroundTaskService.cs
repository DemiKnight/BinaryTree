...
using FrontEnd.BackgroundTasks;
...
{
    /**
     * @brief Responsible for running the background tasks when needed. 
     */
    internal class BackgroundTaskService : ActivationHandler<BackgroundActivatedEventArgs>
    {
        ...
        private static IEnumerable<BackgroundTask> CreateInstances()
        {
            ...
            backgroundTasks.Add(new IngestTextBackgroundTask());
            backgroundTasks.Add(new GenerateStatisticsBackgroundTask());
