...
namespace FrontEnd.BackgroundTasks
{
    /**
     * @brief Upon ingest of data or changes to filters, this process will update analytics of the selected text.
     */
    class GenerateStatisticsBackgroundTask : BackgroundTask
    {
